...
public class CategoryResponse {
   ...
   @Generated
   public void setContent(final List<CategoryDTO> content) {
   ...
   public String toString() {
      ...
      return "CategoryResponse(content=" + var10000 + ", pageNumber=" + this.getPageNumber() + ", pageSize=" + this.getPageSize() + ", totalElements=" + this.getTotalElements() + ", totalPages=" + this.getTotalPages() + ", lastPage=" + this.isLastPage() + ")";
   }
   ...
   @Generated
   public CategoryResponse(final List<CategoryDTO> content, final Integer pageNumber, final Integer pageSize, final Long totalElements, final Integer totalPages, final boolean lastPage) {
      this.content = content;
      this.pageNumber = pageNumber;
      this.pageSize = pageSize;
      this.totalElements = totalElements;
