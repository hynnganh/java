...
public class UserResponse {
   ...
   @Generated
   public void setContent(final List<UserDTO> content) {
   ...
   public String toString() {
      ...
      return "UserResponse(content=" + var10000 + ", pageNumber=" + this.getPageNumber() + ", pageSize=" + this.getPageSize() + ", totalElements=" + this.getTotalElements() + ", totalPages=" + this.getTotalPages() + ", lastPage=" + this.isLastPage() + ")";
   }
   ...
   @Generated
   public UserResponse(final List<UserDTO> content, final Integer pageNumber, final Integer pageSize, final Long totalElements, final Integer totalPages, final boolean lastPage) {
      this.content = content;
      this.pageNumber = pageNumber;
      this.pageSize = pageSize;
      this.totalElements = totalElements;
